! function (h, N) {
    ...
    me.fn = me.prototype = {
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[1] || {}, s = 2), "object" == typeof a || me.isFunction(a) || (a = {}), u === s && (a = this, --s); s < u; s++)
            if (null != (i = arguments[s]))
                for (r in i) e = a[r], a !== (n = i[r]) && (l && n && (me.isPlainObject(n) || (t = me.isArray(n))) ? (o = t ? (t = !1, e && me.isArray(e) ? e : []) : e && me.isPlainObject(e) ? e : {}, a[r] = me.extend(l, o, n)) : n !== N && (a[r] = n));
        return a
    }, me.extend({
        ...
        parseJSON: function (e) {
            return h.JSON && h.JSON.parse ? h.JSON.parse(e) : null === e ? e : "string" == typeof e && ((e = me.trim(e)) && w.test(e.replace(E, "@").replace(S, "]").replace(k, ""))) ? Function("return " + e)() : (me.error("Invalid JSON: " + e), N)
        },
        parseXML: function (e) {
            var t;
            if (!e || "string" != typeof e) return null;
        ...
        proxy: function (e, t) {
            var n, r, i;
            return "string" == typeof t && (i = e[t], t = e, e = i), me.isFunction(e) ? (n = c.call(arguments, 2), (r = function () {
                return e.apply(t || this, n.concat(c.call(arguments)))
            }).guid = e.guid = e.guid || me.guid++, r) : N
        },
    ...
    me.Callbacks = function (i) {
        var e, n;
        i = "string" == typeof i ? M[i] || (n = M[e = i] = {}, me.each(e.match(C) || [], function (e, t) {
            n[t] = !0
        }), n) : me.extend({}, i);
        var r, t, o, a, s, u, l = [],
            c = !i.once && [],
    ...
    function O(e, t, n, r) {
        if (me.acceptData(e)) {
            var i, o, a = me.expando,
                ...
                l = u ? me.cache : e,
                c = u ? e[a] : e[a] && a;
            if (c && l[c] && (r || l[c].data) || !s || n !== N) return c || (u ? e[a] = c = f.pop() || me.guid++ : c = a), l[c] || (l[c] = {}, u || (l[c].toJSON = me.noop)), ("object" == typeof t || "function" == typeof t) && (r ? l[c] = me.extend(l[c], t) : l[c].data = me.extend(l[c].data, t)), i = l[c], r || (i.data || (i.data = {}), i = i.data), n !== N && (i[me.camelCase(t)] = n), s ? null == (o = i[t]) && (o = i[me.camelCase(t)]) : o = i, o
        }
    }
    ...
    me.extend({
        ...
        data: function (t, e) {
            ...
            if (t !== N) return "object" == typeof t ? this.each(function () {
                ...
                return e === N ? i ? P(i, t, me.data(i, t)) : null : (this.each(function () {
                    me.data(this, t, e)
                }), N)
    ...
    me.fn.extend({
        ...
        toggleClass: function (o, a) {
            ...
            return me.isFunction(o) ? this.each(function (e) {
                ...
                if ("string" === s)
                    for (var e, t = 0, n = me(this), r = a, i = o.match(C) || []; e = i[t++];) r = u ? r : !n.hasClass(e), n[r ? "addClass" : "removeClass"](e);
        ...
        val: function (r) {
            ...
            })) : t ? (i = me.valHooks[t.type] || me.valHooks[t.nodeName.toLowerCase()]) && "get" in i && (e = i.get(t, "value")) !== N ? e : "string" == typeof (e = t.value) ? e.replace(z, "") : null == e ? "" : e : void 0
        }
    }), me.extend({
        valHooks: {
            option: {
        ...
        attr: function (e, t, n) {
            var r, i, o, a = e.nodeType;
            if (e && 3 !== a && 8 !== a && 2 !== a) return typeof e.getAttribute === y ? me.prop(e, t, n) : ((i = 1 !== a || !me.isXMLDoc(e)) && (t = t.toLowerCase(), r = me.attrHooks[t] || (V.test(t) ? $ : W)), n === N ? r && i && "get" in r && null !== (o = r.get(e, t)) ? o : (typeof e.getAttribute !== y && (o = e.getAttribute(t)), null == o ? N : o) : null !== n ? r && i && "set" in r && (o = r.set(e, n, t)) !== N ? o : (e.setAttribute(t, n + ""), n) : (me.removeAttr(e, t), N))
        },
        removeAttr: function (e, t) {
            var n, r, i = 0,
                o = t && t.match(C);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = me.propFix[n] || n, V.test(n) ? !J && Y.test(n) ? e[me.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : me.attr(e, n, ""), e.removeAttribute(J ? n : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    me.event = {
            ...
            add: function (e, t, n, r, i) {
                var o, a, s, u, l, c, f, p, d, h, g, m = me._data(e);
                if (m) {
                    for (n.handler && (n = (u = n).handler, i = u.selector), n.guid || (n.guid = me.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || ((c = m.handle = function (e) {
                            return typeof me === y || e && me.event.triggered === e.type ? N : me.event.dispatch.apply(c.elem, arguments)
                        }).elem = e), s = (t = (t || "").match(C) || [""]).length; s--;) d = g = (o = te.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), l = me.event.special[d] || {}, d = (i ? l.delegateType : l.bindType) || d, l = me.event.special[d] || {}, f = me.extend({
                        type: d,
                        origType: g,
                        data: r,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, u), (p = a[d]) || ((p = a[d] = []).delegateCount = 0, l.setup && !1 !== l.setup.call(e, r, h, c) || (e.addEventListener ? e.addEventListener(d, c, !1) : e.attachEvent && e.attachEvent("on" + d, c))), l.add && (l.add.call(e, f), f.handler.guid || (f.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, f) : p.push(f), me.event.global[d] = !0;
                    e = null
                }
            },
                ...
                if (m && (c = m.events)) {
                    for (l = (t = (t || "").match(C) || [""]).length; l--;)
                        if (d = g = (s = te.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
                            for (f = me.event.special[d] || {}, p = c[d = (r ? f.delegateType : f.bindType) || d] || [], s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) a = p[o], !i && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
                            u && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || me.removeEvent(e, d, m.handle), delete c[d])
                        } else
                            for (d in c) me.event.remove(e, d + t[l], n, r, !0);
            ...
            trigger: function (e, t, n, r) {
                ...
                if (a = l = n = n || g, 3 !== n.nodeType && 8 !== n.nodeType && !ee.test(p + me.event.triggered) && (0 <= p.indexOf(".") && (p = (d = p.split(".")).shift(), d.sort()), o = p.indexOf(":") < 0 && "on" + p, (e = e[me.expando] ? e : new me.Event(p, "object" == typeof e && e)).isTrigger = !0, e.namespace = d.join("."), e.namespace_re = e.namespace ? RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = N, e.target || (e.target = n), t = null == t ? [e] : me.makeArray(t, [e]), u = me.event.special[p] || {}, r || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                    ...
                    for (c = 0;
                        (a = f[c++]) && !e.isPropagationStopped();) e.type = 1 < c ? s : u.bindType || p, (i = (me._data(a, "events") || {})[e.type] && me._data(a, "handle")) && i.apply(a, t), (i = o && a[o]) && me.acceptData(a) && i.apply && !1 === i.apply(a, t) && e.preventDefault();
                ...
                if ((s[0] = e).delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                    for (a = me.event.handlers.call(this, e, u), t = 0;
                        ...
                        for (e.currentTarget = i.elem, o = 0;
                            (r = i.handlers[o++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, (n = ((me.event.special[r.origType] || {}).handle || r.handler).apply(i.elem, s)) !== N && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
            ...
            return this instanceof me.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? ne : re) : this.type = e, t && me.extend(this, t), this.timeStamp = e && e.timeStamp || me.now(), this[me.expando] = !0, N) : new me.Event(e, t)
        }, me.Event.prototype = {
        ...
        function (n, r) {
            var e, T, w, o, t, h, l, N, g, C, i, m, y, a, s, v, c, k = "sizzle" + -new Date,
                b = n.document,
                x = {},
                E = 0,
                f = 0,
            ...
            for (e in t = re.isXML = function (e) {
                    ...
                    return u !== C && 9 === u.nodeType && u.documentElement && (i = (C = u).documentElement, m = t(u), x.tagNameNoComments = ne(function (e) {
                    ...
                    }, x.getIdNotName ? (w.find.ID = function (e, t) {
                    ...
                    }), w.find.TAG = x.tagNameNoComments ? function (e, t) {
                    ...
                    })), (x.matchesSelector = Z(s = i.matchesSelector || i.mozMatchesSelector || i.webkitMatchesSelector || i.oMatchesSelector || i.msMatchesSelector)) && ne(function (e) {
                        ...
                        var n;
                        return e === t ? (l = !0, 0) : (n = t.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(t)) ? 1 & n || e.parentNode && 11 === e.parentNode.nodeType ? e === u || v(b, e) ? -1 : t === u || v(b, t) ? 1 : 0 : 4 & n ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                    } : function (e, t) {
                        var n, r = 0,
                            i = e.parentNode,
                            o = t.parentNode,
                    ...
                    }, l = !1, [0, 0].sort(c), x.detectDuplicates = l), C
                }, re.matches = function (e, t) {
                    return re(e, null, null, t)
                }, re.matchesSelector = function (e, t) {
                    if ((e.ownerDocument || e) !== C && g(e), t = t.replace(G, "='$1']"), !(!x.matchesSelector || m || a && a.test(t) || y.test(t))) try {
                        var n = s.call(e, t);
                    ...
                    var n;
                    return (e.ownerDocument || e) !== C && g(e), m || (t = t.toLowerCase()), (n = w.attrHandle[t]) ? n(e) : m || x.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && !0 === e[t] ? t : n && n.specified ? n.value : null
                }, re.error = function (e) {
                    ...
                    filter: {
                            ...
                            return 1 === h && 0 === g ? function (e) {
                                ...
                                if (c) {
                                    ...
                                    if (u = [y ? c.firstChild : c.lastChild], y && p) {
                                        ...
                                        for (;
                                            (o = ++s && o && o[l] || (a = s = 0) || u.pop()) && ((v ? o.nodeName.toLowerCase() !== f : 1 !== o.nodeType) || !++a || (p && ((o[k] || (o[k] = {}))[d] = [E, a]), o !== e)););
                        ...
                        PSEUDO: function (e, o) {
                            ...
                            return a[k] ? a(o) : 1 < a.length ? (t = [e, e, "", o], w.setFilters.hasOwnProperty(e.toLowerCase()) ? te(function (e, t) {
                    ...
                    pseudos: {
                        not: te(function (e) {
                            var r = [],
                                i = [],
                                s = h(e.replace(B, "$1"));
                            return s[k] ? te(function (e, t, n, r) {
            ...
            function de(d, h, g, m, y, e) {
                return m && !m[k] && (m = de(m)), y && !y[k] && (y = de(y, e)), te(function (e, t, n, r) {
                    var i, o, a, s = [],
                        u = [],
                        l = t.length,
                        c = e || function (e, t, n) {
            ...
            h = re.compile = function (e, t) {
                ...
                if (!a) {
                    ...
                    a = d(e, (m = o, b = (v = 0) < (y = i).length, x = 0 < m.length, r = function (e, t, n, r, i) {
                        var o, a, s, u = [],
                            l = 0,
                            c = "0",
                            f = e && [],
                ...
                return a
            }, w.pseudos.nth = w.pseudos.eq, w.filters = ge.prototype = w.pseudos, w.setFilters = new ge, g(), re.attr = me.attr, me.find = re, me.expr = re.selectors, me.expr[":"] = me.expr.pseudos, me.unique = re.uniqueSort, me.text = re.getText, me.isXMLDoc = re.isXML, me.contains = re.contains
        }(h);
    var ie = /Until$/,
    ...
    Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, me.fn.extend({
        text: function (e) {
        ...
        domManip: function (n, r, i) {
            ...
            var e, t, o, a, s, u, l, c, f = 0,
                ...
                g = n[0],
                m = me.isFunction(g);
            if (m || !(p <= 1 || "string" != typeof g || me.support.checkClone) && Ne.test(g)) return this.each(function (e) {
                var t = d.eq(e);
            ...
            if (p && (e = (u = me.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === u.childNodes.length && (u = e), e)) {
                for (r = r && me.nodeName(e, "tr"), o = (a = me.map(Me(u, "script"), je)).length; f < p; f++) t = u, f !== h && (t = me.clone(t, !0, !0), o && me.merge(a, Me(t, "script"))), i.call(r && me.nodeName(this[f], "table") ? (l = this[f], c = "tbody", l.getElementsByTagName(c)[0] || l.appendChild(l.ownerDocument.createElement(c))) : this[f], t, f);
                if (o)
                    for (s = a[a.length - 1].ownerDocument, me.map(a, De), f = 0; f < o; f++) t = a[f], Ce.test(t.type || "") && !me._data(t, "globalEval") && me.contains(s, t) && (t.src ? me.ajax({
                        url: t.src,
                        type: "GET",
                        dataType: "script",
                        async: !1,
        ...
        clone: function (e, t, n) {
            ...
            if (me.support.html5Clone || me.isXMLDoc(e) || !he.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ae.innerHTML = e.outerHTML, Ae.removeChild(o = Ae.firstChild)), !(me.support.noCloneEvent && me.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || me.isXMLDoc(e)))
        ...
        buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, p = fe(t), d = [], h = 0; h < f; h++)
                ...
                if (!me.support.leadingWhitespace && ge.test(o) && d.push(t.createTextNode(ge.exec(o)[0])), !me.support.tbody)
                    for (i = (o = "table" !== u || be.test(o) ? "<table>" !== c[1] || be.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) me.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
    ...
    function nt(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += me.css(e, n + Ge[o], !0, i)), r ? ("content" === n && (a -= me.css(e, "padding" + Ge[o], !0, i)), "margin" !== n && (a -= me.css(e, "border" + Ge[o] + "Width", !0, i))) : (a += me.css(e, "padding" + Ge[o], !0, i), "padding" !== n && (a += me.css(e, "border" + Ge[o] + "Width", !0, i)));
        return a
    }
    ...
    function it(e) {
        var t = g,
            n = Ve[e];
        return n || ("none" !== (n = ot(e, t)) && n || ((t = ((Fe = (Fe || me("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement))[0].contentWindow || Fe[0].contentDocument).document).write("<!doctype html><html><body>"), t.close(), n = ot(e, t), Fe.detach()), Ve[e] = n), n
    }
    ...
    me.fn.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if ("string" === (o = typeof n) && (i = Ue.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(me.css(e, t)), o = "number"), !(null == n || "number" === o && isNaN(n) || ("number" !== o || me.cssNumber[s] || (n += "px"), me.support.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && (n = a.set(e, n, r)) === N))) try {
                    u[t] = n
                } catch (e) {}
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = me.camelCase(t);
            return t = me.cssProps[s] || (me.cssProps[s] = Ke(e.style, s)), (a = me.cssHooks[t] || me.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), o === N && (o = Be(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), !0 === n || me.isNumeric(i) ? i || 0 : o) : o
        },
        ...
        var r, i, o, a = n || Oe(e),
            ...
            u = e.style;
        return a && ("" !== s || me.contains(e.ownerDocument, e) || (s = me.style(e, t)), Xe.test(s) && Ie.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = s, s = a.width, u.width = r, u.minWidth = i, u.maxWidth = o)), s
        ...
        me.cssHooks[i] = {
            get: function (e, t, n) {
                return t ? 0 === e.offsetWidth && $e.test(me.css(e, "display")) ? me.swap(e, Ye, function () {
                    return rt(e, i, n)
                }) : rt(e, i, n) : N
            },
            set: function (e, t, n) {
    ...
    pt = Tt.exec(dt.toLowerCase()) || [], me.fn.load = function (e, t, n) {
        ...
        var r, i, o, a = this,
            s = e.indexOf(" ");
        return 0 <= s && (r = e.slice(s, e.length), e = e.slice(0, s)), me.isFunction(t) ? (n = t, t = N) : t && "object" == typeof t && (o = "POST"), 0 < a.length && me.ajax({
            url: e,
            type: o,
            dataType: "html",
            data: t
        ...
        ajax: function (e, t) {
            ...
            var n, r, c, f, p, d, h, i, g = me.ajaxSetup({}, t),
                m = g.context || g,
            ...
            if (v.promise(w).complete = b.add, w.success = w.done, w.error = w.fail, g.url = ((e || g.url || dt) + "").replace(mt, "").replace(xt, pt[1] + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = me.trim(g.dataType || "*").toLowerCase().match(C) || [""], null == g.crossDomain && (n = Tt.exec(g.url.toLowerCase()), g.crossDomain = !(!n || n[1] === pt[1] && n[2] === pt[2] && (n[3] || ("http:" === n[1] ? 80 : 443)) == (pt[3] || ("http:" === pt[1] ? 80 : 443)))), g.data && g.processData && "string" != typeof g.data && (g.data = me.param(g.data, g.traditional)), St(Nt, g, t, w), 2 === T) return w;
            for (r in (d = g.global) && 0 == me.active++ && me.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !bt.test(g.type), c = g.url, g.hasContent || (g.data && (c = g.url += (gt.test(c) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (g.url = yt.test(c) ? c.replace(yt, "$1_=" + ht++) : c + (gt.test(c) ? "&" : "?") + "_=" + ht++)), g.ifModified && (me.lastModified[c] && w.setRequestHeader("If-Modified-Since", me.lastModified[c]), me.etag[c] && w.setRequestHeader("If-None-Match", me.etag[c])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && w.setRequestHeader("Content-Type", g.contentType), w.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : g.accepts["*"]), g.headers) w.setRequestHeader(r, g.headers[r]);
            ...
            function u(e, t, n, r) {
                ...
                }(g, w, n)), 200 <= e && e < 300 || 304 === e ? (g.ifModified && ((u = w.getResponseHeader("Last-Modified")) && (me.lastModified[c] = u), (u = w.getResponseHeader("etag")) && (me.etag[c] = u)), 204 === e ? (i = !0, l = "nocontent") : 304 === e ? (i = !0, l = "notmodified") : (l = (i = function (e, t) {
                    var n, r, i, o, a = {},
                        s = 0,
                        u = e.dataTypes.slice(),
                        l = u[0];
                ...
                }(g, s)).state, o = i.data, i = !(a = i.error))) : (a = l, (e || !l) && (l = "error", e < 0 && (e = 0))), w.status = e, w.statusText = (t || l) + "", i ? v.resolveWith(m, [o, l, w]) : v.rejectWith(m, [w, l, a]), w.statusCode(x), x = N, d && y.trigger(i ? "ajaxSuccess" : "ajaxError", [w, g, i ? o : a]), b.fireWith(m, [w, l]), d && (y.trigger("ajaxComplete", [w, g]), --me.active || me.event.trigger("ajaxStop")))
            }
            return w
        },
    ...
    } : _t, Ht = me.ajaxSettings.xhr(), me.support.cors = !!Ht && "withCredentials" in Ht, (Ht = me.support.ajax = !!Ht) && me.ajaxTransport(function (l) {
        var c;
        if (!l.crossDomain || me.support.cors) return {
            send: function (e, a) {
                var s, t, u = l.xhr();
    ...
    me.Animation = me.extend(zt, {
        tweener: function (e, t) {
            for (var n, r = 0, i = (e = me.isFunction(e) ? (t = e, ["*"]) : e.split(" ")).length; r < i; r++) n = e[r], $t[n] = $t[n] || [], $t[n].unshift(t)
        },
